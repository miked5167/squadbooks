...
```bash
python scripts/evaluate_ui.py http://localhost:3000 ./results
```
...
**Accessibility only:**
```bash
python scripts/test_accessibility.py http://localhost:3000 ./a11y-results
```

**Visual design analysis:**
```bash
python scripts/visual_testing.py analyze http://localhost:3000
```

**Visual regression baselines:**
```bash
python scripts/visual_testing.py baseline http://localhost:3000
```

**Functionality testing:**
```bash
python scripts/test_functionality.py http://localhost:3000
```
...
**Usage**: `python scripts/evaluate_ui.py <url> [output_dir]`
...
**Usage**: `python scripts/test_accessibility.py <url> [output_dir]`
...
**Usage**: `python scripts/test_functionality.py <url> [output_dir]`
...
2. **During development**: Quick accessibility checks
   ```bash
   python scripts/test_accessibility.py http://localhost:3000
   ```

3. **Before commits**: Run comprehensive evaluation
   ```bash
   python scripts/evaluate_ui.py http://localhost:3000
   ```
...
**Accessibility**: `references/wcag-standards.md`
- WCAG 2.1 compliance levels
- Common issues and fixes
- Testing checklist

**Visual Design**: `references/design-best-practices.md`
- Color theory and palette guidelines
- Typography systems
- Spacing and layout principles
- Design consistency

**Performance**: `references/performance-standards.md`
...
```bash
pip install playwright pytest-playwright axe-playwright-python --break-system-packages
