...
interface TransactionDetailsDrawerProps {
  ...
  canEdit?: boolean // Optional prop to control edit button visibility (default: true for team users, false for association users)
}

export function TransactionDetailsDrawer({ transaction, open, onOpenChange, canEdit = true }: TransactionDetailsDrawerProps) {
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-full sm:max-w-lg overflow-y-auto bg-white">
        ...
        <div className="mt-6 space-y-6">
          ...
          {/* Edit Button - Only shown for users with edit permissions (team treasurers) */}
          {canEdit && (
