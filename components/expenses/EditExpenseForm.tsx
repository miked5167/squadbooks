...
export function EditExpenseForm({ transactionId }: EditExpenseFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect back to transactions with a small delay
      // If we came from a filtered view, try to preserve it via browser history
      setTimeout(() => {
        // Try to go back first (preserves filter state if available)
