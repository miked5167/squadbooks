...
export const teamProfileSchema = z.object({
  ...
  teamType: z.enum(['HOUSE_LEAGUE', 'REPRESENTATIVE', 'ADULT_RECREATIONAL', 'OTHER']).optional().nullable(),
  ageDivision: z.enum(['U7', 'U9', 'U11', 'U13', 'U15', 'U18', 'OTHER']).optional().nullable(),
  competitiveLevel: z.enum(['AAA', 'AA', 'A', 'BB', 'B', 'MD', 'HOUSE_RECREATIONAL', 'NOT_APPLICABLE', 'OTHER']).optional().nullable(),
  ...
  seasonStartDate: z.union([z.string().datetime(), z.date()]).optional().nullable(),
  seasonEndDate: z.union([z.string().datetime(), z.date()]).optional().nullable(),
