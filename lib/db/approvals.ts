 ...
 */
export async function getAllApprovals(teamId: string, status?: ApprovalStatus, limit = 50) {
...
export async function approveTransaction(
  ...
  // Send notification email to the creator (non-blocking, dynamic import to avoid Resend init issues)
  try {
    const { sendApprovalStatusEmail } = await import('@/lib/email')
