...
Note: FILTER-01 (team multi-select) is already satisfied by existing TeamFilter.tsx component from Phase 2 (verified: lines 34, 92-101 show multi-select state management with handleToggleTeam, handleSelectAll, handleClearAll; component supports multiple team selection via checkboxes with "Select All" / "Clear All" functionality). This plan adds date, missing receipts, and search filters.
</objective>
