...
/**
 * Process batch 21-30 associations
 * Uses proven fixed-extraction logic
 */

const batch = JSON.parse(fs.readFileSync('next-batch-21-30.json', 'utf8'));
...
(async () => {
  console.log('='.repeat(80));
  console.log('BATCH PROCESSING - ASSOCIATIONS 21-30');
  console.log('='.repeat(80));
  ...
  for (let i = 0; i < batch.length; i++) {
    ...
    // Progressive save
    fs.writeFileSync('batch-21-30-results.json', JSON.stringify(results, null, 2));
  }
  ...
  // Summary
  console.log('\n\n' + '='.repeat(80));
  console.log('BATCH 21-30 SUMMARY');
  console.log('='.repeat(80));
  ...
  console.log('\n\nResults saved to: batch-21-30-results.json');
  ...
  if (newOnes.length > 0) {
    ...
    console.log('\nNo new extractions in this batch');
  }
  ...
  if (validations.length > 0) {
    ...
    console.log('No validations in this batch (all new extractions)');
  }

  // Cumulative summary
  console.log('\n' + '='.repeat(80));
  console.log('CUMULATIVE PROGRESS (BATCHES 1-30)');
  console.log('='.repeat(80));
  console.log('Total associations processed: 30');
  console.log(`New extractions so far: Check all batch results`);
})();
