  ...
  return (
    <div className="space-y-4">
      <Alert>
        ...
        <AlertDescription>
          GTHL (Greater Toronto Hockey League) requires specific signing authority composition to
          ensure proper governance and financial oversight.
        </AlertDescription>
      </Alert>

      <Card>
        <CardHeader>
          <CardTitle>Composition Requirements</CardTitle>
        </CardHeader>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>Minimum number of parent representatives required</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
        ...
        <CardContent className="space-y-4">
            ...
            render={({ field }) => (
              <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                <div className="space-y-0.5">
                  <FormLabel className="text-base">Require Finance Experience</FormLabel>
                  <FormDescription>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                <div className="space-y-0.5">
                  <FormLabel className="text-base">Require Background Check</FormLabel>
                  <FormDescription>
