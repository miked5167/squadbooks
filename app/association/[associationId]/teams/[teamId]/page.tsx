...
export default async function TeamDetailPage({ params }: PageProps) {
  ...
  // Serialize transactions for client component (convert Decimal to number, Date to string)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          {recentTransactions.length > 0 ? (
            <TransactionTable transactions={serializedTransactions} associationId={associationId} totalCount={allTransactions.length} />
          ) : (
            <div className="bg-white border border-gray-200 rounded-lg p-8 text-center text-gray-500">
              No transactions yet
            </div>
